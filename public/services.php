...
<head>
    ...
    <title>FleetControl Service Options</title>
    ...
    <div class="container-fluidtext-bg-dark p-3">
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="card text-bg-dark p-3">
                    <div class="card-body">
                        <h5 class="card=title">FleetControl Service Options</h5>
                        <ul>
                            <li><a href="addservice.php"><button type="button" class="btn btn-success">Add Service</button></a></li>
                            <li><a href="selectservicecenter.php"><button type="button" class="btn btn-success">Select Service Center</button></a></li>
                            <li><a href="selectservicetype.php"><button type="button" class="btn btn-success">Select Service Type</button></a></li>
                            <li><a href="deleteservice.php"><button type="button" class="btn btn-danger">Delete Service</button></a></li>
                        </ul>
                    </div>
                </div>
            </div>
