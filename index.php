            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li>
                            <a class="nav-item nav-link link-light" href="about.php">ABOUT</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="card text-bg-dark p-3">
                        <center>
                            <img src="public/img/Truck_368x368.jpg" class="img-thumbnail" alt="image of a semi-truck" width="300px" height="300px">
                        </center>
                    </div>
                </div>
                <div class="col">
                    <div class="card">
                        ...
                        <form action="index.php" method="post" class="form login-form">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-input" type="text" name="txtUserName" placeholder="Username" id="txtUserName" title="Enter your username" required>
                            </div>
                            ...
                            <div class="form-group mar-bot-5">
                                ...
                                <input class="form-input" type="password" name="password" placeholder="Password" id="password" title="Enter your password" required>
                            </div>
                            <br>
